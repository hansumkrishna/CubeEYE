    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C0204R.C0206id.topPanel) {
                    topPanel = child;
                } else if (id == C0204R.C0206id.buttonPanel) {
                    buttonPanel = child;
                } else if ((id != C0204R.C0206id.contentPanel && id != C0204R.C0206id.customPanel) || middlePanel != null) {
                    return false;
                } else {
                    middlePanel = child;
                }

...
public final class ViewPropertyAnimatorCompat {
    ...
    interface ViewPropertyAnimatorCompatImpl {
        ...
        /* renamed from: x */
        void mo2995x(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        void xBy(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        /* renamed from: y */
        void mo2997y(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        void yBy(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        /* renamed from: z */
        void mo2999z(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);
    ...
    static class BaseViewPropertyAnimatorCompatImpl implements ViewPropertyAnimatorCompatImpl {
        ...
        /* renamed from: x */
        public void mo2995x(ViewPropertyAnimatorCompat vpa, View view, float value) {
            postStartMessage(vpa, view);
        }
        ...
        /* renamed from: y */
        public void mo2997y(ViewPropertyAnimatorCompat vpa, View view, float value) {
            postStartMessage(vpa, view);
        }
        ...
        /* renamed from: z */
        public void mo2999z(ViewPropertyAnimatorCompat vpa, View view, float value) {
        }
    ...
    /* renamed from: x */
    public ViewPropertyAnimatorCompat mo2957x(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.mo2995x(this, view, value);
        }
        return this;
    }
    ...
    /* renamed from: y */
    public ViewPropertyAnimatorCompat mo2959y(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.mo2997y(this, view, value);
        }
        return this;
    }
    ...
    /* renamed from: z */
    public ViewPropertyAnimatorCompat mo2961z(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.mo2999z(this, view, value);
        }
        return this;
    }
